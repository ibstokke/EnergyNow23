...
def Algorithm(Pmin, Pmax, reservoir):
...
def plot():
    ...
    output, income_el, income_as = Algorithm(Pmin, Pmax, reservoir)
    ...
    ASCost_label = Label(right_frame, text="ASCost = " + str(income_as))
    ELCost_label = Label(right_frame, text="ELCost = " + str(income_el))
...
Pmax_label = Label(left_frame, text ='Maximal Capacity [MW]')
Pmax_label.grid(column=0, row=0)

Pmax_entry = Entry(left_frame, textvariable=Pmax)
Pmax_entry.grid(column=1, row=0)

Pmin_label = Label(left_frame, text = "Minimal Capacity [MW]")
Pmin_label.grid(column=0, row=1)

Pmin_entry = Entry(left_frame, textvariable=Pmin)
Pmin_entry.grid(column=1, row=1)

Res_label = Label(left_frame, text ='Reservoir Capacity [MWh]')
Res_label.grid(column=0, row=2)

Res_entry = Entry(left_frame, textvariable=res)
Res_entry.grid(column=1, row=2)

Calc_button = Button(left_frame, text="Calculate", command=plot)
Calc_button.grid(column=0, row=3)

Status_label = Label(right_frame)
